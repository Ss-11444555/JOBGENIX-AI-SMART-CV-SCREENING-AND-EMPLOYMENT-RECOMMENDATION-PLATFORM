document.addEventListener("DOMContentLoaded", () => {
    ...
    const sidebar = document.querySelector(".sidebar-jobseeker");
    ...
    if (sidebar && main && menuBtn) {
        ...
        document.addEventListener("click", (e) => {
            if (
                ...
                !e.target.closest(".sidebar-jobseeker") &&
    ...
    const showLogoutConfirm = () => {
        ...
        desc.textContent = "You will be signed out of your job seeker account.";
    ...
    if (logoutBtn) {
        ...
        console.warn("[sidebar] jobseekerLogoutBtn not found");
    }
    ...
    document.addEventListener(
        "click",
        (e) => {
            const btn = e.target.closest && e.target.closest("#jobseekerLogoutBtn");
            if (!btn) return;
